...
export function DoseCalculator() {
  ...
  return (
    <Card className="flex flex-col gap-4 w-full max-w-md mx-auto">
      ...
      {result !== null && (
        <div className="mt-4 p-4 rounded-xl bg-success/10 border border-success/20 shadow-inner border border-border bg-foreground/5 flex flex-col items-center justify-center">
